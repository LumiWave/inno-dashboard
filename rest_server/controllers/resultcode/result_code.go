...
const (
	...
	Result_Get_Me_WalletList_Scan_Error = 34003 // GetMeWalletList DB Scan Error
	Result_Get_Me_PointList_Scan_Error  = 34004 // GetMePointList DB Scan Error
	Result_Get_Me_CoinList_Scan_Error   = 34005 // GetMeCoinList DB Scan Error
...
var ResultCodeText = map[int]string{
	...
	Result_GetApp_Point_Scan_Error: "Get App Point DB Scan Error",
	Result_GetApp_Coin_Scan_Error:  "Get App Coin DB Scan Error",
