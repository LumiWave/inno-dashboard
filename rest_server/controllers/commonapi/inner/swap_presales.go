...
// func MakePreSalesSwapInfo(token *auth.VerifyAuthToken, reqSwapInfo *context.ReqSwapInfo) *point_manager_server.ReqSwapInfo {
...
// func CheckPreSalesSwapFee(swapInfo *point_manager_server.ReqSwapInfo, resp *base.BaseResponse) {
...
// // swap에 필요한 코인 보유량 체크
// func CheckPreSalesSwapCoinBalance(swapInfo *point_manager_server.ReqSwapInfo, resp *base.BaseResponse) {
