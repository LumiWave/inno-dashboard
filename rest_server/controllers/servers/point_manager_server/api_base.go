...
var ApiList = map[api_kind]ApiInfo{
	...
	Api_put_swap_status: ApiInfo{ApiType: Api_put_swap_status, Uri: "/swap/status", Method: "PUT",
		ResponseFuncType: func() interface{} { return new(ResSwapStatus) }, client: NewClient()},
