...
func (o *DB) USPPR_Strt_PreSalesExchanges(salesID int64, auid, muid, baseCoinID, walletID int64, walletAddress string,
...
func (o *DB) USPPR_Cmplt_PreSalesExchanges(txID int64, pointID int64, prePointQuantity int64, adjPointQuantity string, pointQuantity int64) (int64, error) {
